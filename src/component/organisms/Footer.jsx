   ...
   return (
      ...
      >
         ...
         <div className="mt-6 flex flex-wrap items-center justify-center gap-5 lg:gap-8">
            <ButtonIcon
               url="https://github.com/rikkyagung"
               icon={
                  <svg
            ...
            />
            <ButtonIcon
               url="https://linkedin.com/in/rikkyagung"
               icon={
                  <svg
                     xmlns="http://www.w3.org/2000/svg"
                     width="28"
            ...
            />
            <ButtonIcon
               url="https://instagram.com/rikkyagung/"
               icon={
                  <svg
                     xmlns="http://www.w3.org/2000/svg"
                     width="28"
         ...
         <span className="my-6 text-sm">Designed & Built by Agung © 2022</span>
      </footer>
   );
}
